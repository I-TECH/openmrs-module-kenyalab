...
<div class="ke-page-content">
	${ ui.includeFragment("kenyaemr", "patient/patientList", [ id: "results", showNumResults: true, pageProvider: "kenyalab", page: "labentry/labEntryViewPatient", heading: "Matching Patients"]) }
</div>
